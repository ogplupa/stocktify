                ...
                <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        ...
                        <tr class="hover:bg-gray-100 dark:hover:bg-gray-700" data-user-id={{$user['id']}}>
                            ...
                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white user-name">
                                {{ $user->name }}
                            </td>
                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white user-email">
                                {{ $user->email }}
                            </td>
                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white user-username">
                                {{ $user->username }}
                            </td>
                            <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white user-role">
                                {{ $user->role->name }}
                            </td>
...
<script>
    function setEditUser(id) {
        ...
        const userUsername = userRow.querySelector('.user-username').innerText;
        ...
        document.querySelector('#edit-user-modal input[name="username"]').value = userUsername;
        document.querySelector('#edit-user-modal select[name="role_id"]').value = userRole;
        document.querySelector('#edit-user-modal form').setAttribute('action', `/user/update/${id}`);
    }
    ...
    function setDeleteUser(id) {
        ...
        deleteForm.setAttribute('action', `/user/delete/${id}`);
    }
</script>
@endpush